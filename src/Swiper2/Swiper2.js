...
const Swiper2 = () => {
  ...
  return (
    <>
    <div className="unserLine"><h4 className="carosal2-h2">Our Brand</h4></div>
    <div className="carousel-container">
      <Slider {...settings}>
        {cards.map((card, index) => (
          <div className="swiper2-1">
          <Swiper2Card2 key={index} title={<img className="swiper2-img" src={card.title}></img>} description={card.description} />
          <h5>AVAITOR TATINUM</h5>
          <span>Price Rs:695</span>
          <div className="cardBtnDiv">
          <button className="swiper2-btn">Add Cart</button>
          </div>
          </div>
