  ...
  return (
    <>
      <div className="nav">
        ...
        <li onClick={openProfile} className="nav-ques">
          <FaQuestionCircle />
        </li>
        <span className="nav-serch">
          <CiSearch />
        </span>
        <button onClick={handleGoJointoLogin} className="nav-btn">
          Join
        </button>
      ...
      <div className="nav-res">
        <div className="nav-res-1">
          <span onClick={handleGoNavtoHome}>
            <IoHome />
          </span>
        </div>
        <div className="nav-res-2">
          <span onClick={handleMobileLogin}>
            <FaUser />
          </span>
        </div>
